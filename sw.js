...
self.addEventListener('fetch',e=>{
  ...
  const url=new URL(e.request.url),isCore=e.request.mode==='navigate'||/\/(?:index\.html|styles\.css|app\.js|v012\.js|v013\.js|v014\.js|v018_guard\.js|v016\.js|v017\.js|v019_wod_library\.js|v020_day_swipe\.js|db\.js|manifest\.webmanifest)$/.test(url.pathname);
  if(isCore){
