const CACHE='training-journal-v0.1.3';
const CORE=['./','./index.html','./styles.css?v=0.1.1','./db.js','./app.js?v=0.1.1','./v012.js?v=0.1.2','./v013.js?v=0.1.3','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
...
self.addEventListener('fetch',e=>{
  ...
  const url=new URL(e.request.url),isCore=e.request.mode==='navigate'||/\/(?:index\.html|styles\.css|app\.js|v012\.js|v013\.js|db\.js|manifest\.webmanifest)$/.test(url.pathname);
  if(isCore){
